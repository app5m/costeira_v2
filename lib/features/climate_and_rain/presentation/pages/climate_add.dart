...
class ClimateAdd extends StatefulWidget {
  const ClimateAdd({super.key});

  @override
  State<ClimateAdd> createState() => _ClimateAddState();
}

class _ClimateAddState extends State<ClimateAdd> {
  final ClimateAddPageController _pageController =
      Modular.get<ClimateAddPageController>();
