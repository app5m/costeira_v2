...
class _PotreirosState extends State<Potreiros>
  ...
  final PotreirosPageController _pageController =
      Modular.get<PotreirosPageController>();
  final PotreiroListPageController _listPageController =
      Modular.get<PotreiroListPageController>();
  ...
  Future<void> _openAdd() async {
    ...
    _showMessage(
      result?['message']?.toString() ?? 'Potreiro salvo com sucesso.',
      isError: false,
    );
  }
  ...
  Future<void> _showFilterSheet() async {
    final result = await showModalBottomSheet<PotreiroFilterSheetResult>(
      ...
      builder: (_) => PotreiroFilterSheet(
        initialStatusAtual: _listPageController.currentStatusFilter,
      ),
    );
            ...
            child: Column(
              children: [
                ...
                if (_pageController.tabIndex == 0)
                  const Expanded(child: DadosPotreiros()),
                        ...
                        builder: (context) {
                          ...
                          if (_listPageController.potreiros.isEmpty) {
                            return ListView(
                              children: const [
                                ...
                                Center(
                                  child: Text(
                                    'Nenhum potreiro cadastrado até agora.',
                                  ),
                                ),
                              ],
                            );
                          ...
                          return ListView.builder(
                            ...
                            itemBuilder: (context, index) {
                              final potreiro =
                                  _listPageController.potreiros[index];
