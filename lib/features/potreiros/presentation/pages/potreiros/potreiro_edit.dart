...
class PotreiroEdit extends StatefulWidget {
  const PotreiroEdit({super.key, required this.potreiro});

  final PotreiroEntity potreiro;

  @override
  State<PotreiroEdit> createState() => _PotreiroEditState();
}

class _PotreiroEditState extends State<PotreiroEdit> {
  static const _decimalFormatter = FixedTwoDecimalInputFormatter();

  final PotreiroEditPageController _pageController =
      Modular.get<PotreiroEditPageController>();

  @override
  void initState() {
    super.initState();
    _pageController.init(widget.potreiro);
  }
              ...
              child: Column(
                children: [
                  ...
                  _buildDropdown(
                    ...
                    PotreiroEditPageController.statusOptions,
                  ...
                  _buildDropdown(
                    ...
                    PotreiroEditPageController.acessoOptions,
