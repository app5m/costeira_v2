...
class _NotificationsPageState extends State<NotificationsPage> {
  ...
  void initState() {
    super.initState();
    _notificationsRepository = Modular.get<NotificationsRepository>();
    _loadNotifications();
  }
  ...
  Future<void> _loadNotifications() async {
    ...
    try {
      ...
      final notifications = await _notificationsRepository.fetchNotifications(_user!.id);
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              ElevatedButton(onPressed: _loadNotifications, child: const Text('Tentar novamente')),
            ],
          ),
        ),
      );
...
typedef NotificacoesScreen = NotificationsPage;
