import 'package:costeira/features/movimentacoes/domain/entities/abigeato_animal_entity.dart';
import 'package:costeira/features/movimentacoes/infra/models/movimentacao_reference_model.dart';

class AbigeatoAnimalModel extends AbigeatoAnimalEntity {
  const AbigeatoAnimalModel({
  ...
  factory AbigeatoAnimalModel.fromJson(Map<String, dynamic> json) {
    return AbigeatoAnimalModel(
