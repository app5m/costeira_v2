...
class TrocaCategoriaAnimalModel extends TrocaCategoriaAnimalEntity {
  const TrocaCategoriaAnimalModel({
  ...
  factory TrocaCategoriaAnimalModel.fromJson(Map<String, dynamic> json) {
    return TrocaCategoriaAnimalModel(
      ...
      catgOrigem: MovimentacaoReferenceModel.maybeFromJson(json['catg_origem']),
      catgDestino: MovimentacaoReferenceModel.maybeFromJson(
        json['catg_destino'],
      ),
