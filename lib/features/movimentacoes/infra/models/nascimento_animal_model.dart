...
class NascimentoAnimalModel extends NascimentoAnimalEntity {
  const NascimentoAnimalModel({
  ...
  factory NascimentoAnimalModel.fromJson(Map<String, dynamic> json) {
    return NascimentoAnimalModel(
