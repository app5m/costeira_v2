...
class MorteAnimalModel extends MorteAnimalEntity {
  const MorteAnimalModel({
  ...
  factory MorteAnimalModel.fromJson(Map<String, dynamic> json) {
    return MorteAnimalModel(
