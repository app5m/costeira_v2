...
class AbortoAnimalModel extends AbortoAnimalEntity {
  const AbortoAnimalModel({
  ...
  factory AbortoAnimalModel.fromJson(Map<String, dynamic> json) {
    return AbortoAnimalModel(
