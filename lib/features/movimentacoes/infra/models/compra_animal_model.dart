...
class CompraAnimalModel extends CompraAnimalEntity {
  const CompraAnimalModel({
  ...
  factory CompraAnimalModel.fromJson(Map<String, dynamic> json) {
    return CompraAnimalModel(
