...
import 'package:costeira/features/movimentacoes/consumo/presentation/pages/consumo_animais_page.dart';
import 'package:costeira/theme/colors.dart';
import 'package:flutter/material.dart';
import 'package:flutter_modular/flutter_modular.dart';

class ConsumoFormPage extends StatefulWidget {
  const ConsumoFormPage({super.key, this.consumo});

  final ConsumoUpsertEntity? consumo;

  @override
  State<ConsumoFormPage> createState() => _ConsumoFormPageState();
}
...
class _ConsumoFormPageState extends State<ConsumoFormPage> {
  ...
  void initState() {
    super.initState();
    _pageController.init(consumo: widget.consumo);
  }
      ...
      builder: (context, _) {
        return Scaffold(
          ...
          appBar: AppBar(
            ...
            title: Text(
              _pageController.isEdit ? 'Editar consumo' : 'Adicionar consumo',
            ...
            child: Column(
              ...
              children: [
                ...
                _buildTextField(
                  ...
                  label: 'Observações',
                  hint: 'Digite as observações sobre o consumo',
                  maxLines: 3,
                ),
                if (_pageController.isEdit)
                  const _ReadOnlyHint(
