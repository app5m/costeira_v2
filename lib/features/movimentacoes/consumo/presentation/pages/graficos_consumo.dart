...
class GraficosConsumo extends StatefulWidget {
  const GraficosConsumo({super.key});

  @override
  State<GraficosConsumo> createState() => _GraficosConsumoState();
}

class _GraficosConsumoState extends State<GraficosConsumo> {
  final GetConsumoChartsController _controller =
      Modular.get<GetConsumoChartsController>();
  ...
  Widget build(BuildContext context) {
    ...
    final data = charts ?? ConsumoChartsEntity.empty;
    return Expanded(
      child: RefreshIndicator(
        ...
        child: ListView(
          ...
          children: [
            ...
            _TotalCard(value: data.quantidadeConsumos),
            const SizedBox(height: 16),
...
class _MonthlyCard extends StatelessWidget {
  ...
  final List<ConsumoMonthlyEntity> points;
...
class _MonthBar extends StatelessWidget {
  ...
  final ConsumoMonthlyEntity point;
  final int maxValue;
