...
class AddVendaController extends ChangeNotifier {
  AddVendaController(this._createVendaUsecase);

  final CreateVendaUsecase _createVendaUsecase;
  ...
  Future<ApiMessage?> submit(VendaUpsertEntity venda) async {
    ...
    try {
      ...
      return await _createVendaUsecase(venda.copyWith(appUsersId: user.id));
