...
class GetCompraChartsController extends ChangeNotifier {
  GetCompraChartsController(this._getCompraChartsUsecase);

  final GetCompraChartsUsecase _getCompraChartsUsecase;

  bool _isLoading = false;
  String? _errorMessage;
  CompraChartsEntity? _charts;
  DateTime _month = DateTime.now();
  int _reloadVersion = 0;

  bool get isLoading => _isLoading;
  String? get errorMessage => _errorMessage;
  CompraChartsEntity? get charts => _charts;
  ...
  Future<void> load({DateTime? month}) async {
    ...
    try {
      ...
      final result = await _getCompraChartsUsecase(
