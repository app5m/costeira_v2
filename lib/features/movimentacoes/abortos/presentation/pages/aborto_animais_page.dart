...
class AbortoAnimaisPage extends StatelessWidget {
  const AbortoAnimaisPage({super.key, required this.pageController});

  final AbortoFormPageController pageController;
            ...
            children: [
              Padding(
                ...
                child: TextField(
                  ...
                  decoration: InputDecoration(
                    hintText: 'Filtrar por brinco, peso ou lote',
              ...
              Expanded(
                child: pageController.isLoading
                    ...
                    : pageController.errorMessage != null
                    ? Center(
                        child: Padding(
