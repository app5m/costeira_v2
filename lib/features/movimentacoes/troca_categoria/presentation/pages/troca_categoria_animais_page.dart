...
class TrocaCategoriaAnimaisPage extends StatelessWidget {
  const TrocaCategoriaAnimaisPage({super.key, required this.pageController});

  final TrocaCategoriaFormPageController pageController;
