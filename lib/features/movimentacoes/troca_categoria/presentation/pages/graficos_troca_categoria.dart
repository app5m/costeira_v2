      ...
      child: RefreshIndicator(
        ...
        child: ListView(
          ...
          children: [
            ...
            const SizedBox(height: 16),
            _TrocaChartCard(points: data.mesAMes),
          ],
        ),
      ),
    );
...
class _TrocaChartCard extends StatelessWidget {
  const _TrocaChartCard({required this.points});

  final List<TrocaCategoriaMonthlyEntity> points;
        ...
        children: [
          ...
          SizedBox(
            ...
            child: points.isEmpty
                ...
                : CustomPaint(
                    painter: _TrocaBarPainter(points: points),
...
class _TrocaBarPainter extends CustomPainter {
  _TrocaBarPainter({required this.points});
  ...
  @override
  bool shouldRepaint(covariant _TrocaBarPainter oldDelegate) {
