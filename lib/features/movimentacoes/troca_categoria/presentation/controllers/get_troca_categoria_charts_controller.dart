...
class GetTrocaCategoriaChartsController extends ChangeNotifier {
  GetTrocaCategoriaChartsController(this._getTrocaCategoriaChartsUsecase);

  final GetTrocaCategoriaChartsUsecase _getTrocaCategoriaChartsUsecase;

  bool _isLoading = false;
  String? _errorMessage;
  TrocaCategoriaChartsEntity? _charts;
  DateTime _month = DateTime.now();
  int _reloadVersion = 0;

  bool get isLoading => _isLoading;
  String? get errorMessage => _errorMessage;
  TrocaCategoriaChartsEntity? get charts => _charts;
  ...
  Future<void> load({DateTime? month}) async {
    ...
    try {
      ...
      final result = await _getTrocaCategoriaChartsUsecase(
