...
class GraficosTransferencia extends StatefulWidget {
  const GraficosTransferencia({super.key});

  @override
  State<GraficosTransferencia> createState() => _GraficosTransferenciaState();
}

class _GraficosTransferenciaState extends State<GraficosTransferencia> {
  final GetTransferenciaChartsController _controller =
      Modular.get<GetTransferenciaChartsController>();
  ...
  Widget build(BuildContext context) {
    ...
    final data = charts ?? TransferenciaChartsEntity.empty;
    return Expanded(
      child: RefreshIndicator(
        ...
        child: ListView(
          ...
          children: [
            ...
            _TotalCard(value: data.quantidadeTransferencias),
            const SizedBox(height: 16),
            _TransferenciaChartCard(points: data.mesAMes),
          ],
        ),
      ),
    );
...
class _TransferenciaChartCard extends StatelessWidget {
  const _TransferenciaChartCard({required this.points});

  final List<TransferenciaMonthlyEntity> points;
        ...
        children: [
          ...
          SizedBox(
            ...
            child: points.isEmpty
                ...
                : CustomPaint(
                    painter: _TransferenciaBarPainter(points: points),
...
class _TransferenciaBarPainter extends CustomPainter {
  _TransferenciaBarPainter({required this.points});
  ...
  @override
  bool shouldRepaint(covariant _TransferenciaBarPainter oldDelegate) {
