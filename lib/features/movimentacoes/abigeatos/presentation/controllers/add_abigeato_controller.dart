...
class AddAbigeatoController extends ChangeNotifier {
  AddAbigeatoController(this._createAbigeatoUsecase, this._resolveCurrentFarmId);

  final CreateAbigeatoUsecase _createAbigeatoUsecase;
  ...
  Future<ApiMessage?> submit(AbigeatoUpsertEntity abigeato) async {
    ...
    try {
      ...
      if (farmId == null) {
        throw ApiException('Cadastre uma fazenda antes de registrar o abigeato.');
      }

      return await _createAbigeatoUsecase(
