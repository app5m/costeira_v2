...
class GetMorteChartsController extends ChangeNotifier {
  GetMorteChartsController(this._getMorteChartsUsecase);

  final GetMorteChartsUsecase _getMorteChartsUsecase;

  bool _isLoading = false;
  String? _errorMessage;
  MorteChartsEntity? _charts;
  DateTime _month = DateTime.now();
  int _reloadVersion = 0;

  bool get isLoading => _isLoading;
  String? get errorMessage => _errorMessage;
  MorteChartsEntity? get charts => _charts;
  ...
  Future<void> load({DateTime? month}) async {
    ...
    try {
      ...
      final result = await _getMorteChartsUsecase(
