...
class MovimentacaoDateFilterResult {
  const MovimentacaoDateFilterResult({
...
class MovimentacaoDateFilterSheet extends StatefulWidget {
  const MovimentacaoDateFilterSheet({
    super.key,
    this.initialDataIn,
    this.initialDataOut,
  });
  ...
  @override
  State<MovimentacaoDateFilterSheet> createState() =>
      _MovimentacaoDateFilterSheetState();
}

class _MovimentacaoDateFilterSheetState
    extends State<MovimentacaoDateFilterSheet> {
  ...
  bool get _canClear =>
      _hasCurrentFilters && (_hasChanges || _hadInitialFilters);

  @override
  void initState() {
    super.initState();
    _dataInController = TextEditingController(text: widget.initialDataIn ?? '');
    _dataOutController = TextEditingController(
      text: widget.initialDataOut ?? '',
    );
