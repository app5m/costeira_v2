...
class InsumosDatasourceImpl implements InsumosDatasource {
  ...
  Future<ApiMessage> deleteInsumo(DeleteInsumoEntity insumo) async {
    ...
    return _offlineApiService.postOrEnqueue(
      ...
      payload: payload,
      priority: SyncPriority.insumos,
      pendingMessage: 'Exclusão do insumo salva para sincronizar.',
  ...
  Future<ApiMessage> deleteInsumoRegistro(DeleteInsumoEntity registro) async {
    ...
    return _offlineApiService.postOrEnqueue(
      ...
      payload: payload,
      priority: SyncPriority.insumos,
      pendingMessage: 'Exclusão do registro de insumo salva para sincronizar.',
...
const Map<String, dynamic> _emptyInsumosListResponse = {
  'rows': 0,
  'data': {'lista': <Map<String, dynamic>>[], 'registros': <Map<String, dynamic>>[]},
};
