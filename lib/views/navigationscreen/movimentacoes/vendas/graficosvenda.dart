    ...
    return Expanded(
      child: Column(children: [
        Row(
          ...
          children: [
            buildContainer('Total vendido', '+2,4% último mês', 'R\$ 184.750,00', Color(0xFF228046), Color(0xFFACFFB3)),
            buildContainer('kg vendidos', '+1,2% último mês',  '52.300 kg', Color(0xFF228046), Color(0xFFACFFB3)),
          ],),
        SizedBox(height: 16,),
        Row(
          mainAxisAlignment: MainAxisAlignment.spaceBetween,
        ...
        Image.asset('icon/vendas.png', width: MediaQuery.of(context).size.width, fit: BoxFit.cover,),
      ],),
    );
  }
