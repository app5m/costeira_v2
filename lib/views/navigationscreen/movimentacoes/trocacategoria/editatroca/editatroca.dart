...
class EditTroca extends StatefulWidget {
  const EditTroca({super.key});

  @override
  State<EditTroca> createState() => _EditTrocaState();
}

class _EditTrocaState extends State<EditTroca> {
