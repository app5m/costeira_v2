...
import 'package:costeira/views/navigationscreen/movimentacoes/transferencias/addtransferencia/addtransferencia.dart';
import 'package:costeira/views/navigationscreen/movimentacoes/transferencias/ddetailtransferencia/detailtransferencia.dart';
import 'package:costeira/views/navigationscreen/movimentacoes/transferencias/editatransferencia/editatransferencia.dart';
...
class _TransferenciaState extends State<Transferencia>  with SingleTickerProviderStateMixin {
        ...
        if(index == 0)
          Expanded(child: ListView.builder(
            ...
            return GestureDetector(
              onTap: (){
                Navigator.push(context,
                    MaterialPageRoute(builder: (_) => const DetailTransferencia()));
              },
              child: Container(
                        ...
                        Column(
                          ...
                          children: [
                            ...
                            GestureDetector(
                              onTap: () {
                                Navigator.push(context,
                                    MaterialPageRoute(builder: (_) => const Editransferencia()));
                              },
