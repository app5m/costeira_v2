...
import 'package:costeira/views/navigationscreen/movimentacoes/compras/compras.dart';
    ...
    return Scaffold(
      ...
      body: Container(
        ...
        child: Column(children: [
          ...
          GestureDetector(
              onTap: (){
                Navigator.push(context, MaterialPageRoute(builder: (context) => Vendas()));
              },child: ButtonMotivetion('Vendas',)),
          SizedBox(height: 16,),
          GestureDetector(
            onTap: (){
              Navigator.push(context, MaterialPageRoute(builder: (context) => Mortes()));
            }, child: ButtonMotivetion('Mortes',)),
          SizedBox(height: 16,),
          GestureDetector(
              onTap: (){
                Navigator.push(context, MaterialPageRoute(builder: (context) => Nascimentos()));
          ...
          GestureDetector(
              onTap: (){
                Navigator.push(context, MaterialPageRoute(builder: (context) => TrocaCategoria()));

              },child: ButtonMotivetion('Trocas de categoria',)),
          SizedBox(height: 16,),
          GestureDetector(
            onTap: (){
              Navigator.push(context, MaterialPageRoute(builder: (context) => Abortos()));
