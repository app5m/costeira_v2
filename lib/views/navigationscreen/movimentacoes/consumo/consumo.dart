...
import 'package:costeira/views/navigationscreen/movimentacoes/consumo/addconsumo/addconsumo.dart';
import 'package:costeira/views/navigationscreen/movimentacoes/consumo/detailconsumo/detailconsumo.dart';
import 'package:costeira/views/navigationscreen/movimentacoes/consumo/editaconsumo/editaconsumo.dart';
        ...
        if(index == 0)
          Expanded(child: ListView.builder(
            ...
            return GestureDetector(
              onTap: (){
                Navigator.push(context,
                    MaterialPageRoute(builder: (_) => const DetailConsumo()));
              },
              child: Container(
                        ...
                        Column(
                          ...
                          children: [
                            ...
                            GestureDetector(
                              onTap: () {
                                Navigator.push(context,
                                    MaterialPageRoute(builder: (_) => const EditConsumo()));
                              },
