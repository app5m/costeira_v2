...
import 'package:costeira/views/navigationscreen/Menu/Modulos/sanitarios/execucoes/detaliexecucoes/detailexecucoes.dart';
...
class _ExecucoesState extends State<Execucoes>  with SingleTickerProviderStateMixin {
                          ...
                          child: Row(
                            ...
                            children: [
                              Container(
                                ...
                                child: SvgPicture.asset('icon/square-chart-gantt.svg', width: 16, height: 16, color: Color(0xFF8C8C8C),),
                              ),
                            ],
                          ),
                        ),
