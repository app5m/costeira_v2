...
import 'package:costeira/views/navigationscreen/Menu/Modulos/estoquedeinsumos/addestoque/addcompra.dart';
import 'package:costeira/views/navigationscreen/Menu/Modulos/estoquedeinsumos/detailinsumo/detailinsumo.dart';
import 'package:costeira/views/navigationscreen/Menu/Modulos/tarefas/addtarefa/addtarefa.dart';
import 'package:costeira/views/navigationscreen/Menu/Modulos/tarefas/detailtarefa/detailtarefa.dart';
import 'package:costeira/views/navigationscreen/Menu/Modulos/tarefas/editatarefa/editatarefa.dart';
...
import 'addestoque/addinsumo.dart';
import 'graficosinsumo.dart';
...
class _InsumosState extends State<Insumos>  with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      floatingActionButton: index == 0 ?  SpeedDial(
          ...
          SpeedDialChild(
            ...
            onTap: () {
              Navigator.push(context,
                  MaterialPageRoute(builder: (_) => const AddCompraInsumo()));
            },
          ),
                          ...
                          child: Row(
                            ...
                            children: [
                              Container(
                                ...
                                child: SvgPicture.asset('icon/diamond.svg', width: 16, height: 16, color: Color(0xFF8C8C8C),),
                              ),
                            ],
                          ),
                        ),
                        ...
                        Column(
                          ...
                          children: [
                            ...
                            GestureDetector(
                              onTap: () {
                                // Navigator.push(context,
                                //     MaterialPageRoute(builder: (_) => const EditTarefa()));
                              },
