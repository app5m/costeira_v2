    ...
    return Expanded(
      child: SingleChildScrollView(
        child: Column(children: [
          ...
          Image.asset('images/chuvaacumulada.png', width: MediaQuery.of(context).size.width, fit: BoxFit.cover,),
          Image.asset('images/mmdd.png', width: MediaQuery.of(context).size.width, fit: BoxFit.cover,),
          Image.asset('images/comparativoentreanos.png', width: MediaQuery.of(context).size.width, fit: BoxFit.cover,),
        ],),
      ),
    );
  }
